...
namespace Factory
{
    public class FactoryMPartener
    {
        ...
        {
            DataSet ds = new DataSet();
            ds = SqlHelper.ExecuteDataset(Config.Crebas, "p_g_checkLogin_massage_partner_oxpay", Email_id, "W");
            return ds;
        }
        public DataSet convert_to_sgd(string currency, string amount)
        {
            DataSet ds = new DataSet();
            ds = SqlHelper.ExecuteDataset(Config.Crebas, "dbo.p_c_amt_to_sgd", currency, amount);
            return ds;
        }
        ...
        public DataSet get_QRs() {
            ...
            DataSet ds = SqlHelper.ExecuteDataset(Config.Crebas, "sp_select_QR");
            return ds;
        }

        public DataSet get_user_country_payments(string country_sk)
        {
            DataSet ds = SqlHelper.ExecuteDataset(Config.Crebas, "p_g_user_country_payments", country_sk);
            return ds;
        }
        public string getPymntImgs(string content)
        {
            DataSet ds = SqlHelper.ExecuteDataset(Config.Crebas, "dbo.p_g_pymntImages", content);
