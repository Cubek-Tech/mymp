...
namespace Factory
{
    public class FactorySendMail
    {

        DataSet ds;

        //added by nilesh g for feedback mail
        public static int SendMail(string reply_to,string sender, string Mrecipients, string Msubject, string Mbody, string Attechment)
        {

            return SqlHelper.ExecuteNonQuery(Config.Crebas, "p_SendMail_feedback",  reply_to,sender, Mrecipients, Msubject, Mbody, Attechment);
        ...
        //public int SendMailerrormail(string sender, string Mrecipients, string Msubject, string Mbody, string imageurl, string Attechment)
        //{
        //    return SqlHelper.ExecuteNonQuery(Config.Crebas, "p_SendMail_error", sender, Mrecipients, Msubject, Mbody, imageurl,Attechment);
        //}
        public static int SendMailalert(int? service_provider_sk, string sender, string Mrecipients, string Msubject, string Mbody, string Attechment)
        {
            // SqlHelper.ExecuteNonQuery(Config.Crebas, "p_sendmail_alertcopy", service_provider_sk, sender, Mrecipients, Msubject+"duplicate mail", Mbody, Attechment);
            return SqlHelper.ExecuteNonQuery(Config.Crebas, "p_sendmail_alert", service_provider_sk, sender, Mrecipients, Msubject, Mbody, Attechment);
        }
        ...
        //{
        //    ds = new DataSet();
        //    int? log_sk = Convert.ToInt32(logsk);
        //    ds = SqlHelper.ExecuteDataset(Config.Crebas, "p_g_image_data", log_sk);
        //    return ds.Tables[0];
        //}
        ...
        {
            ds = new DataSet();
            ds = SqlHelper.ExecuteDataset(Config.Crebas, "p_g_provider_reminder");
            return ds.Tables[0];
        }
        ...
        public static int send_notification_mail(string sender, string Mrecipients, string Msubject, string Mbody,int notification_type_sk,int notification_method_sk,int? slot_booking_sk,int? service_provider_sk,int? service_seeker_sk,char login_type)
        {
           ...
           public static int send_notification_mail_Provider_annual_sub(int service_provider_sk)
        {
            return SqlHelper.ExecuteNonQuery(Config.Crebas, "p_SendMail_Provider_Subscription_Info",service_provider_sk);
        ...
        {
            ds = new DataSet();
            ds = SqlHelper.ExecuteDataset(Config.Crebas, "p_g_varifyreview_template");
            return ds.Tables[0];
        }
        public int sendMail(int login_sk, string Msubject, string Mbody, string fileattachment)
        {
            int i = 0;
            i = SqlHelper.ExecuteNonQuery(Config.Crebas, "p_send_acknowledge_paypal_submittion", login_sk, Msubject, Mbody, fileattachment);
            return i;
        }


        public static int SendMail_Contactus(
            string sender,
            string Mrecipients, 
            string Msubject, 
            string Mbody, 
            ...
            string Attechment)
        {
            ...
            return SqlHelper.ExecuteNonQuery(Config.Crebas, "p_SendMail_Contactus", sender, Mrecipients, Msubject, Mbody, UserType, Attechment);
        ...
        {
            int i = 0;
            i = SqlHelper.ExecuteNonQuery(Config.Crebas, "p_sendSubscriptionMail", login_sk);
            return i;
        }
        ...
        {
            int i = 0;
            i = SqlHelper.ExecuteNonQuery(Config.Crebas, "p_SendMail_Activate_Your_Listings", Service_provider_sk);
            return i;
        }
        ...
        {
            int i = 0;
            i = SqlHelper.ExecuteNonQuery(Config.Crebas, "p_SendMail_Buy_leads_subscription_mail", Service_provider_sk);
            return i;
        }
        public int send_Buy_Rank_Provider(int Service_provider_sk)
        {
            int i = 0;
            i = SqlHelper.ExecuteNonQuery(Config.Crebas, "p_SendMail_Buy_Rank_subscription_mail", Service_provider_sk);
            return i;
        }
