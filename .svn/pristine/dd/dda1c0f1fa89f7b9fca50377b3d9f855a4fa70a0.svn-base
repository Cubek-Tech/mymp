<%@ Page Language="C#" Inherits="Pay" Codebehind="Pay.aspx.cs" AutoEventWireup="true"
...
<body onload="a2()" style="background-color:lightgray; margin-left:300px; margin-right:300px; margin-top:0px;">
    ...
    <form runat="server" name="frmTransaction" id="frmTransaction" onsubmit="return validateForm()" autocomplete="off" >
        <div>
            ...
            <table width="700" style="text-align:left; ">
                ...
                <tr>
                    ...
                    <td align="left" width="50%"><input id="account_id" name="account_id" type="text" value="24050" runat="server" /></td>
                </tr>
                <tr>
              ...
              <tr>
                ...
                <tr>
                    ...
                    <td align="left"><input id="return_url" name="return_url" type="text" value="http://localhost:31731/response.aspx" runat="server" /></td>
                </tr>
                <tr>
                    <td class="fieldName">*Mode</td>
                   <td align="left"><input id="mode" name="mode" type="text" value="LIVE" runat="server" ></td>
                </tr>
    ...
    <td align="left"> <select id="algo" name="algo" runat="server">
      ...
      <option value="SHA512">SHA512</option>
                ...
                <tr>
                    ...
                    <td align="left" width="50%"><input id="reference_no" name="reference_no" type="text" value="23131313" runat="server" /></td>
                </tr>
                <tr>
                    <td class="fieldName"><span class="error">*</span>Sale Amount</td>
                    <td align="left" width="50%"><input id="amount" name="amount" type="text" value="1200" runat="server" /></td>
                </tr>
                <tr>
                     <td class="fieldName"><span class="error">*</span>Description</td>
                    <td align="left" width="50%"><input id="description" name="description" type="text" value="testing purpose" runat="server" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left"><input id="name" name="name" type="text" value="amit jain" runat="server" /></td>
                </tr>
                <tr>
                    <td class="fieldName"><span class="error">*</span>Address</td>
                    <td align="left"><input id="address" name="address" type="text" value="kalapipal main road" runat="server" /></td>
                </tr>
                <tr>
                    <td class="fieldName"><span class="error">*</span>City</td>
                    <td align="left"><input id="city" name="city" type="text" value="kalapipal" runat="server" /></td>
                </tr>
                <tr>
                    <td class="fieldName">*State/Province</td>
                    <td align="left"><input id="state" name="state" type="text" value="MP" runat="server" /></td>
                </tr>
                <tr>
                    <td class="fieldName"><span class="error">*</span>ZIP/Postal Code</td>
                    <td align="left"><input id="postal_code" name="postal_code" type="text" value="465337" runat="server" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left"><input id="email" name="email" type="text" value="amitjain07625@gmail.com" runat="server" /></td>
                </tr>
                <tr>
                    <td class="fieldName"><span class="error">*</span>Telephone</td>
                    <td align="left"><input id="phone" name="phone" type="text" value="1231231234" runat="server" /></td>
                </tr>
                <tr>
             ...
             <tr>
                    ...
                    <td align="left"><input id="ship_name" name="ship_name" type="text" value="main road" runat="server" /></td>
                </tr>
                <tr>
                    <td class="fieldName"><span class="error">*</span>Ship Address</td>
                    <td align="left"><input id="ship_address" name="ship_address" type="text" value="Bhopal" runat="server" /></td>
                </tr>
                <tr>
                    <td class="fieldName"><span class="error">*</span>Ship City</td>
                    <td align="left"><input id="ship_city" name="ship_city" type="text" value="bhopal" runat="server" /></td>
                </tr>
                <tr>
                    <td class="fieldName">*Ship State</td>
                    <td align="left"><input id="ship_state" name="ship_state" type="text" value="MP" runat="server" /></td>
                </tr>
                 <tr>
                  ...
                  <tr>
                    ...
                    <td align="left"><input id="ship_phone" name="ship_phone" type="text" value="3453453456" runat="server" /></td>
                </tr>
                  <tr>
                    <td class="fieldName"><span class="error">*</span>Ship Postal Code</td>
                    <td align="left"><input id="ship_postal_code" name="ship_postal_code" type="text" value="23456" runat="server" /></td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="left" width="50%"><input id="name_on_card" name="name_on_card" type="text" value="test" runat="server" /></td>
                </tr>

                     <tr>
                    <td class="fieldName" width="50%">*Card Number</td>
                    <td align="left" width="50%"><input id="card_number" name="card_number" type="text" value="4111111111111111" runat="server" /></td>
                </tr>
                
              <tr>
                    <td class="fieldName" width="50%">*Card Expiry</td>
                    <td align="left" width="50%"><input id="card_expiry" name="card_expiry" type="text" value="0716" runat="server"/></td>
                </tr>
                       <tr>
                    <td class="fieldName" width="50%">*CVV</td>
                    <td align="left" width="50%"><input id="card_cvv" name="card_cvv" type="password" value="123" runat="server"/></td>
                </tr></table>
