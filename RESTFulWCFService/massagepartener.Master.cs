...
{
    public partial class massagepartener : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //GetIP();
            //fillDropdown();
            //if (ViewState["selected_country"].ToString() == "India")
            //{
        ...
        #region methods
        private void bind_Css_Links()
        {
            lnk_favicon.Href = Constants__.WEB_ROOT_CDN + "/img/mp.png";
            bootstrap.Href = Constants__.WEB_ROOT_CDN + "/bootstrap/css/bootstrap.css";
            bootstrap_1.Href = Constants__.WEB_ROOT_CDN + "/bootstrap/css/bootstrap.css";
            ...
            css.Href = Constants__.WEB_ROOT_CDN + "/css/style.css";
            css_2.Href = Constants__.WEB_ROOT_CDN + "/css/style.css";
            css1.Href = Constants__.WEB_ROOT_CDN + "/Controls/jquery-ui.css";
            css1_1.Href = Constants__.WEB_ROOT_CDN + "/Controls/jquery-ui.css";
        }
        ...
        protected void lnkfindpartner_Click(object sender, EventArgs e)
        {
            try
            {
