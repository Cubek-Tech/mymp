<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="hide_show_gateways.aspx.cs" Inherits="RESTFulWCFService.Admin.hide_show_gateways" %>
      ...
      <center>  
       <div style="height:auto; width:600px; border:1px solid grey; padding:0px 0px 0px 52px; box-shadow:grey 7px 4px 4px -2px">
        <br />
           ...
           <table>
                   ...
                   <td>Select Country</td><td>
                       <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                           <ContentTemplate>
                            ...
                            <br />
                            <br />
                            <asp:CheckBoxList ID="chkCountries" runat="server"  CssClass="font-weight" ClientIDMode="Static">
                                <asp:ListItem Value="-1" Text="pp"> Other </asp:ListItem>
                            </asp:CheckBoxList>
               ...
               <tr  style="padding-left:0px; padding-top:15px"><td colspan="2"  style="padding-left:0px; padding-top:15px">
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                           <ContentTemplate><asp:Button ID="btnUpdate" runat="server" Text="Save" OnClick="btnUpdate_Click" CssClass="btn btn-gradiant"></asp:Button>
                                </ContentTemplate>
           ...
           <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MP_devConnectionString %>" SelectCommand="select tco.country_name ,tp.parameter_name from t_parameter tp 
inner join t_country_wise_payment_methods tc on tc.payment_method = tp.parameter_sk
inner join t_country tco on tco.country_Sk = tc.country_sk"></asp:SqlDataSource>
        </div>
         </center>
