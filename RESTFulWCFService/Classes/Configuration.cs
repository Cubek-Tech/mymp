...
namespace PayPalIntegration
{
	...
	public class WebConfiguration
	{
		...
		//public string AccountEmail = "mukeshcubek@gmail.com";//"paypal@cubek.com";//"rstrahl@west-wind.com";
		public string AccountEmail = ConfigurationManager.AppSettings["paypal_email"].ToString();//"paypal@cubek.com";//"rstrahl@west-wind.com";
		...
		/// </summary>
        public string CCPayPalEmail = "neer_chat@yahoo.com";
