...
public class NVPAPICaller
{
    ...
    public string APIUsername = "hr_api1.cubek.com";
    private string APIPassword = "64VBQUNSYDZKW3ER";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AxPNqKobpNPAS4DKT4iPUuIUQ-D9";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = Constants__.WEB_ROOT + "/Paypal/Success.aspx";
        string cancelURL = Constants__.WEB_ROOT + "/ServiceProvider/SubscriptionNonFree.aspx";
                        ...
                        string shipToCountryCode, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://www.tabletoreserve.com/default.aspx";
        string cancelURL = "http://www.tabletoreserve.com/default.aspx";
