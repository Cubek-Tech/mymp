...
{
    public partial class multipayment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if ((Session["CurrentURL"].ToString()).Contains("/partner-subscription"))
                    {
                        ...
                        if (Session["mp_login_sk"] != null)
                        {
                            ...
                            else
                            {
                                ...
                                if (ds.Tables[0].Rows.Count >= 1)
                                {
                                    ...
                                    ViewState["massage_partner_sk"] = ds.Tables[0].Rows[0]["massage_partner_sk"];
                                    ...
                                    if (Session["oxPay"] != null && Session["oxPay"].ToString() == "Yes")
                                        i = objmail.sendMail(login_sk, "Massage Partner Pay Now Click event", "user (Massage Partner SK= " + ProviderId + ") is clicked for oxpay for registration subscription " + IS_Mobile_Device, null);
                                    else
                                            ...
                                            try
                                            {
                                                ...
                                                if (Session["oxPay"] != null && Session["oxPay"].ToString() == "Yes")
                                                {
                                                    try
                                                    {
                                                        ...
                                                        //    statusUrl = Constants__.WEB_ROOT + "/partner-subscription?code=oxpay_subscription&user=" + Session["email_id"].ToString() + "&refNo=" + Session["Provider_payment"],
                                                        //    returnUrl = Constants__.WEB_ROOT + "/partner-subscription?code=oxpay_subscription&user=" + Session["email_id"].ToString() + "&refNo=" + Session["Provider_payment"],
                                                    ...
                                                    {
                                                        BussinessSendMail objmail = new BussinessSendMail();
                                                        objmail.sendMail(login_sk, "OxPayError", ex.Message, null);
                                                    }
                                                    return;
                                                }
        ...
        protected string Go_for_Stripe_payment(DataSet ds, string payable_amt, string SeekerCurrency, string carddetails)
        {
            ...
            try
            {
                ...
                SeekerCurrency = "usd";
                int chargetotal = Convert.ToInt32(Double.Parse(payable_amt)) * 100;
        ...
        protected void btnsendtransection_Click(object sender, EventArgs e)
        {
            ...
            string pagedetails = "Massage partner sk - " + Session["massage_partner_sk"].ToString() + "  Email Id - " + txtregisteredmail_id.Text.Trim() + "       Paytm transaction iD " + ctxttransaction.Text.Trim();
        ...
        protected void btnQr_Click(object sender, EventArgs e)
        {
            ...
            string pagedetails = "Massage partner sk - " + Session["massage_partner_sk"].ToString() + "  Email Id - " + txtqr_mail_id.Text.Trim() + "   QR Payment transaction iD " + txtQrTransaction.Text.Trim();
