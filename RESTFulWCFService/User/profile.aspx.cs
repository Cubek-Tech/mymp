                            ...
                            case 1:
                                {
                                    ...
                                    img2.ImageUrl = Constants__.WEB_ROOT + "/image/no_image.jpg";
                                    img3.ImageUrl = Constants__.WEB_ROOT + "/image/no_image.jpg";
                                    img4.ImageUrl = Constants__.WEB_ROOT + "/image/no_image.jpg";
                                    img5.ImageUrl = Constants__.WEB_ROOT + "/image/no_image.jpg";
                                    img6.ImageUrl = Constants__.WEB_ROOT + "/image/no_image.jpg";
                                    break;
                                }
                            case 2:
                                {
                            ...
                            default:
                                {
                                    ...
                                    {
                                        imgprofilpic.ImageUrl = Constants__.WEB_ROOT + "/image/avator-male-1501786059.png";
                                    }
                                    else
                                    {
                                        imgprofilpic.ImageUrl = Constants__.WEB_ROOT + "/image/girl-256.png";
                                    }
                                    img1.ImageUrl = Constants__.WEB_ROOT + "/image/no_image.jpg";
                                    img2.ImageUrl = Constants__.WEB_ROOT + "/image/no_image.jpg";
                                    img3.ImageUrl = Constants__.WEB_ROOT + "/image/no_image.jpg";
                                    img4.ImageUrl = Constants__.WEB_ROOT + "/image/no_image.jpg";
                                    img5.ImageUrl = Constants__.WEB_ROOT + "/image/no_image.jpg";
