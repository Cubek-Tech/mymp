<%@ Page Title="" Language="C#" MasterPageFile="~/SearchPartener.Master" AutoEventWireup="true" CodeBehind="_membership.aspx.cs" Inherits="RESTFulWCFService.User._membership" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <script type="text/javascript">
                            $(".checkboxoucallCM_provider input:checkbox").live('change', function () {
                                ...
                                if ($(this).is(':checked')) {
                                    ...
                                    if ($("#ctl00_ContentPlaceHolder1_checkboxOneYear_provider").is(':checked'))
                                    { $('.lblyearsub').text("1 Year"); }
                                    else if ($("#ctl00_ContentPlaceHolder1_checkboxTwoYear_provider").is(':checked'))
                                    { $('.lblyearsub').text("2 Year"); }
                                    else if ($("#ctl00_ContentPlaceHolder1_checkboxThreeYear_provider").is(':checked'))
                            ...
                            <tr>
                                ...
                                <td style="width: 134px;">
                                    <asp:RequiredFieldValidator CssClass="ErrorMsg" ID="RequiredFieldValidator10_1" runat="server"
                                        ValidationGroup="regStripe_2" ControlToValidate="txtCardName_1" ErrorMessage="Required field"
                                        Display="Dynamic" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator CssClass="ErrorMsg" ID="RequiredFieldValidator12_1" runat="server"
                                        ValidationGroup="regStripe_2" ControlToValidate="txtCardNumber_1" ErrorMessage="Required field"
                                        Display="Dynamic" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator CssClass="ErrorMsg" ID="RequiredFieldValidator13_1" runat="server"
                                        ValidationGroup="regStripe_2" ControlToValidate="txtCardExpirationMonth_1" ErrorMessage="Required field"
                                        Display="Dynamic" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator CssClass="ErrorMsg" ID="RequiredFieldValidator14_1" runat="server"
                                        ValidationGroup="regStripe_2" ControlToValidate="txtCardExpirationYear_1" ErrorMessage="Required field" />
                                    ...
                                    <asp:UpdatePanel runat="server" ID="UpdatePanel34">
                                        <ContentTemplate>
                                            <asp:Button ID="SubmitStripe_1" CssClass="btn345 btn-lg btn-info fontsize_25px"
                                                ...
                                                runat="server" Text="Pay Now" ValidationGroup="regStripe_2" />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                                <td></td>
	...
	card for membership.</strong> In that case, you can pay fees to our <strong>company bank account</strong>
                    ...
                    <div class="col-sm-7" id="paytm_option" runat="server">
                    ...
                    <ul class="list-inline text-center member-ship">
                        <li><strong>1 year Membership-	Rs <asp:Label ID="lbl_1_year" runat="server"></asp:Label> </strong></li>
                        <li><strong>2 year Membership-	Rs <asp:Label ID="lbl_2_year" runat="server"></asp:Label>	 </strong></li>
                        <li><strong>3 year Membership-	Rs <asp:Label ID="lbl_3_year" runat="server"></asp:Label> </strong></li>
                    </ul>
            <div class="row">
                <div class="col-sm-5">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                     <asp:LinkButton ID="lnkChangeQR" runat="server" style="color: white;margin-bottom: 5px;background-color: #cb202d;float: center;margin-left: 33px;display:none  /* align-items: center; */padding: 1px 4px 6px 4px;border-radius: 3px;display:none" OnClick="lnkChangeQR_Click">Change QR Code</asp:LinkButton>
                  <br />
                      <img id="img_paytm" runat="server" src="../image/ptm.jpg" class="img-responsive ptm-img" />
                    <span class="download_icon">
                        <a href="../image/ptm.jpg" download="ptm.jpg" target="_blank">
                        <img src="../image/dwnload_icon.png" style="width:38px; height:28px; margin-top:-112px; margin-left:137px" /></a>
                        <br />
                       <p style="text-align:justify; font-weight:bold"><span style="color:red">Help?</span>
                           Download QR code - Open Paytm QR code scan section - select image icon - Choose MyMassagePartner.com QR code from your mobile photos gallery - Pay now!
                       </p> 
                    </span>
                        </ContentTemplate>
                    </asp:UpdatePanel>
